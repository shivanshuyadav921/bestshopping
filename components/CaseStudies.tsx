...
const ASSET_BASE =
  'https://d2xsxph8kpxj0f.cloudfront.net/310519663778233019/HgWQygy6hcEjZgykeuoFnG';
...
export default function CaseStudies() {
  ...
  /* Reset to the "as received" view whenever a different case is selected —
     every story should open on the problem, not the resolved state. */
  useEffect(() => {
