...
async function main() {
  ...
  const roles = [
    ...
    { name: "Admin", permissions: ["manage_users", "manage_orders", "view_reports", "manage_materials"] },
    { name: "ProductionEngineer", permissions: ["manage_jobs", "view_orders", "view_materials"] },
    { name: "QualityEngineer", permissions: ["manage_inspections", "issue_certificates", "view_orders"] },
    { name: "SalesEngineer", permissions: ["manage_rfqs", "view_orders", "view_customers"] },
    { name: "Customer", permissions: ["create_rfq", "view_own_orders", "download_certificates"] },
  ];
  ...
  const users = [
    { email: "owner@prema.com", name: "Prema Owner", role: UserRole.OWNER },
    { email: "admin@prema.com", name: "Prema Admin", role: UserRole.ADMIN },
    { email: "production@prema.com", name: "Prod Engineer", role: UserRole.PRODUCTION_ENGINEER },
    { email: "quality@prema.com", name: "Quality Inspector", role: UserRole.QUALITY_ENGINEER },
    { email: "sales@prema.com", name: "Sales Desk", role: UserRole.SALES_ENGINEER },
  ...
  if (customerUser) {
    await prisma.customer.upsert({
      ...
      update: { companyName: "Acme Corp", contactPhone: "+1234567890", address: "123 Manufacturing Way, Tech City" },
      create: { userId: customerUser.id, companyName: "Acme Corp", contactPhone: "+1234567890", address: "123 Manufacturing Way, Tech City" },
    });
  }
